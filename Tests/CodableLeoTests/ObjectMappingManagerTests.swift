...
final class ObjectMappingManagerTests: XCTestCase {
    ...
    func test_decodePlist() {
        ...
        guard let url = Bundle.module.url(forResource: "MockFeaturesFile", withExtension: "plist") else {
    ...
    func test_decodeJSON() {
        ...
        guard let url = Bundle.module.url(forResource: "MockOnlineResponseFile", withExtension: "json") else {
            XCTFail("file not found")
            return
        }
